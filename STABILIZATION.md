...
- [ ] Phase 4: modular API, runtime validation and durable data snapshots.
  ...
  - [x] Public article listing and subscriber voting have an isolated router contract for anonymous ETag/304, authenticated no-store responses, login and entitlement boundaries, vote validation, deterministic toggle/upsert timestamps and aggregate counts.
