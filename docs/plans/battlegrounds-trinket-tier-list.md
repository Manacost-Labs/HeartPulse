...
- The supplied Hearthstone controls switch between the statistical table and a card gallery; `view=table|gallery` keeps the selected mode shareable and restorable.
