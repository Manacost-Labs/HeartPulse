...
SEO-, mobile- и stability-дорожные карты требуют общего inventory до массовой правки маршрутов и CSS. Машиночитаемая матрица находится в `src/shared/seo/publicRouteInventory.json` и становится обязательным контрактом для новых публичных маршрутов.
