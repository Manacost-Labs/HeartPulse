...
export const LazyAccountRoute = React.lazy(() => import('../../modules/accountRoute/public'));
...
export const LazyDeckBuilder = React.lazy(loadDeckBuilderModule);
export const LazyArchetypes = React.lazy(loadArchetypesModule);
