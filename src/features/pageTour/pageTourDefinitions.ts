...
export const PAGE_TOURS: readonly PageTourDefinition[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'deck', target: 'fun-decks-deck-list', title: 'Состав и код колоды', description: 'Первые пять строк дают быстрое превью. Раскройте полный состав или сразу скопируйте deck code для импорта в Hearthstone.', mobileDescription: 'Сначала показаны пять строк. Нажмите «Показать всю колоду», чтобы раскрыть состав, либо сразу скопируйте код.', preferredPlacement: 'top' },
