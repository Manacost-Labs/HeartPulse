(function (root, factory) {
  ...
  const DEFAULT_OPTIONS = {
    locale: "ruRU",
    dataUrl: "/api/public-resource/hsjson-api/v1/latest/{locale}/cards.collectible.json",
    artBaseUrl: "/api/public-resource/hsjson/v1/tiles/",
    artFormat: "webp",
    className: "",
    group: true,
    sort: true,
    ...
    archetypeArtBaseUrl: "/api/public-resource/hsjson/v1/256x/",
    archetypeArtFormat: "webp",
    archetypeIconBaseUrl: "/api/public-resource/hsjson/v1/tiles/",
    archetypeIconFormat: "webp",
    stonePortraitArtBaseUrl: "/api/public-resource/hsjson/v1/256x/",
    stonePortraitArtFormat: "webp",
    stonePortraitFrameImage: "/api/public-resource/hsreplay/static/webpack/assets/images/battlegrounds/minion-frame.d21732172d83faeae997.png",
    synergyArtBaseUrl: "/api/public-resource/hsjson/v1/tiles/",
    synergyArtFormat: "webp",
    mulliganArtBaseUrl: "/api/public-resource/hsjson/v1/tiles/",
    mulliganArtFormat: "webp",
    matchupArtBaseUrl: "/api/public-resource/hsjson/v1/tiles/",
    matchupArtFormat: "webp",
    matchupIconBaseUrl: "/api/public-resource/hsjson/v1/tiles/",
