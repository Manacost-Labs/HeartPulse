...
export function publicWebOwner(pathname, enabled = false, method = 'GET', pagesEnabled = false, galleryEnabled = false) {
  ...
  if (pagesEnabled && /^\/(?:faq|privacy|terms|developers\/api|articles|contests|classes|tierlist|legendaries|standard\/(?:matchups|meta|fun-decks))\/?$/.test(pathname)) return 'next';
