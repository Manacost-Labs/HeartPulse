...
- Мана использует настоящий локальный ассет `/assets/mana.png`, визуально вставленный в левое окончание рамки. Цвет редкости остаётся на окантовке и не перекрашивает кристалл.
