...
> Исторический проектный черновик, сохранён при объединении веток 2026-09-22.
> Описанные бюджет, расписание и API не подтверждают внедрение или текущее
> состояние сервисов. Объединение документа не запускает эти работы.
