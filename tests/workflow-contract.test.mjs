...
assert.match(
  ciWorkflow,
  /sudo \/usr\/local\/sbin\/hs-arena-ci-deploy --require-capability=scraper-runtime-probe-v1 --allow-nginx-contract-hash=eb3369cd47fc47eb59fc5564f305ba05e3620476ab4625a8f45dc5131724894d "\$artifact" "\$GITHUB_SHA"/,
