...
точки входа, тесты, документацию и известный долг. Карта schema v3 блокирует
новый бесхозный или одновременно принадлежащий нескольким областям legacy-код
за пределами канонических module/shared roots. Общие client/server roots имеют
собственные стабильные ID, владельца и проверяемые starting points; URL всегда
берутся из существующего канонического route inventory.
