...
export function analyzeArenaSynergies(input: ArenaSynergyAnalysisInput): ArenaSynergyPayload {
  ...
  return {
    ...
    methodology: {
      ...
      note: 'Эффект пары — меньшее из двух сравнений: с силой каждой карты отдельно '
        + 'и с похожими колодами того же класса без полной пары. Проигрышных забегов '
        + 'в источнике нет, поэтому это не причинный прирост побед.',
    },
    dataQuality,
    reliability: {
      sampleMode,
