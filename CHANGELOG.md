...
- Раздел статей подготовлен в Next.js: материалы есть в исходном HTML,
  а личные голоса и VIP-доступ остаются за прежним API. Переключение
  публичного маршрута ожидает проверки нового релиза.
