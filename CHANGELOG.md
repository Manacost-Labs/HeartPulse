...
- Нестабильный новосибирский edge временно исключён из DNS HearthPulse после
  тайм-аутов загрузки стилей, скриптов и изображений. Монитор проверяет два
  работающих узла и не допускает случайного возврата неисправного IP в DNS.
