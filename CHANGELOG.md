...
- Начата отдельная система входа читателей Манакоста через HearthPulse:
  добавлены невключённый OIDC-модуль и зашифрованное хранилище с защитой от
  повторного использования кодов. На действующих сайтах новый вход ещё не
  включён; текущая авторизация и комментарии не изменены.
