...
- Публичная часть конкурсов выделена из административного компонента и
  подготовлена в Next.js с серверным HTML. Правила участия и API остались
  прежними; переключение публичного маршрута ожидает проверки релиза.
