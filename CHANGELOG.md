...
- Публичная часть конкурсов выделена из административного компонента в
  отдельный модуль для переноса `/contests/` на Next.js; правила участия и
  API остались прежними.
