...
- Личный кабинет получил компактную сводку доступа, способа входа и истории
  конкурсов, а способы проверки подписки стали отдельными карточками с понятным
  активным состоянием и адаптацией для мобильных экранов.
