...
- Конструкторы стратегий и тир-листов Полей сражений подготовлены на Next.js:
  публичные описания отделены от инструментов подписчиков, проверены импорт,
  экспорт PNG и сохранение настроек. Переключение Nginx ожидает проверку релиза.
