...
- Тир-лист Полей сражений подготовлен на Next.js: публичное описание отделено
  от статистики подписчиков, а выбранный раздел и источник сохраняются после
  обновления страницы. Переключение публичного маршрута ожидает проверки релиза.
