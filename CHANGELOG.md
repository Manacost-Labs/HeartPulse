...
- Добавлены публичные страницы «Политика конфиденциальности» и «Условия
  использования» с описанием обработки профиля, защищённых сессий, Telegram и
  Boosty; ссылки на документы появились в подвале HearthPulse.
