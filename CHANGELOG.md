...
- Добавлена иконка и поддержка аберраций в фильтрах библиотеки Полей сражений,
  тир-листах, деталях карт и конструкторах. Для заполнения типа у ранее
  импортированных карт требуется обновление импортера и повторная синхронизация.
